...
> **Note on `update-activity-workflow.md`:** This file is auto-generated by the MCP server and may contain a looser definition of `auth_configured`. The definition above takes precedence. "Configured" always means credentials are present in the runtime environment **and** referenced in code — not just acknowledged or provided in conversation.
